...
2. Integrity: Assets of the organization or a user should remain tamper proof. In other words, No un-authorized changes/modifications of the assets should take place.
3. Availability: Assets of the organization or of a user should remain accessible or usable upon demand. We can consider a asset to be not available when the user requests an asset and the request timeouts.

## Assets on Cyberspace

| Information Assets                                                                               | Non-Information Assets                                                                                                                               |
| ------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Information Itself                                                                               | Physical Entities connected on the Internet:<br>e.g. Critical Infrastructure like energy sources, <br>power grid, water supply, public transport<br> |
| Information infrastructure:<br>Internet, embedded systems, <br>firmware, communication protocols | IoTs (Internet of Things):<br>Connected home automations and entertainment<br>systems, Connected and self driving vehicles                           |
